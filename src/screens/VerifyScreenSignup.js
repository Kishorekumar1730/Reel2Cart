          ...
          >
            ...
            >
              ...
              <View style={styles.content}>
                ...
                <View style={styles.topSection}>
                  ...
                  <Text style={styles.title}>
                    {mode === 'login' ? t('signInTitle') : t('verifyDetails')}
                  </Text>

                  <View style={styles.otpStatusBadge}>
                    <MaterialCommunityIcons name="email-check" size={18} color="#059669" />
                    <Text style={styles.otpSentText}>
                      {t('codeSentTo')} <Text style={styles.boldEmail}>{input}</Text>
                    </Text>
                  </View>
                </View>
                ...
                <View style={styles.actionSection}>
                  ...
                  >
                    ...
                    >
                      <Text style={styles.submitButtonText}>{t('verifyAndContinue')}</Text>
              ...
              <View style={styles.footer}>
                <Text style={styles.copyrightText}>© 2026 Reel2Cart • {t('premiumMarketplace')}</Text>
              </View>
            </ScrollView>
          </KeyboardAvoidingView>
        </SafeAreaView>
